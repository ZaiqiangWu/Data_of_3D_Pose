...
from ObjLoader.scene import Scene
from ObjLoader.primitive import init_primitives, G_OBJ_PLANE, make_man
from ObjLoader.node import Sphere, Cube, SnowFigure, ThreePyramid, Man
from ObjLoader.interaction import Interaction
