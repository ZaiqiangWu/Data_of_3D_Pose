...
from ObjLoader.primitive import G_OBJ_CUBE, G_OBJ_SPHERE, G_OBJ_MESH, G_OBJ_MAN
from ObjLoader.transformation import scaling, translation
import ObjLoader.color as color
